...
function Controls({
  display, seam, derivative, runtime, width, height, canResize,
  onDisplayClick, onSeamClick, onDerivativeClick, onRuntimeClick, onWidthChange,
  ...
  return (
    <div>
      <Form className="row">
        <FormGroup className="col-lg-offset-1 col-lg-2 col-sm-4">
          <ToggleButtonGroup
            type="radio"
            name="display"
            value={display}
        ...
        <FormGroup className="col-lg-3 col-sm-4">
          <ToggleButtonGroup
            ...
            name="runtime"
            value={runtime}
            onChange={onRuntimeClick}
          >
            <ToggleButton value="js">Vanilla JS</ToggleButton>
            <ToggleButton value="wasm">Web Assembly</ToggleButton>
          </ToggleButtonGroup>
        </FormGroup>
      </Form>
      <Form className="row">
        <FormGroup
          className="col-lg-offset-1 col-lg-2 col-sm-4"
...
Controls.propTypes = {
  ...
  onRuntimeClick: PropTypes.func.isRequired,
